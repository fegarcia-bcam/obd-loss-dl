...
#SBATCH --qos=xlong
#SBATCH --time=5-12:00:00  # walltime (days-hours:minutes:seconds)
...
#SBATCH --output=../../results/ordclass/slurm-%A_%a.out
...
### Prepare environment
conda activate /scratch/fegarcia/conda-env/ord-class
cd ../..

### Run code
python3 -u -m experim.ordclass.main_experim_dl_classif_ddr --idx "$SLURM_ARRAY_TASK_ID"
