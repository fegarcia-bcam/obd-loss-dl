HYPERPARAMS_COMMON = [
    ...
    {'name': 'class_counts', 'fixed': True, 'value': None},  # to override, will be pre-computed for each dataset
    {'name': 'class_priors', 'fixed': True, 'value': None},  # to override, will be pre-computed for each dataset
    ...
    {'name': 'input_channels', 'fixed': True, 'value': -1},  # to override each dataset

    {'name': 'weights', 'fixed': True, 'value': 'imagenet'},
    {'name': 'freeze_blocks', 'fixed': True, 'value': 'all'},
    # {'name': 'freeze_blocks', 'fixed': True, 'value': 'none'},  # unfreeze all blocks

    {'name': 'dropout', 'fixed': True, 'value': 0.1},
    {'name': 'adapt', 'fixed': True, 'value': 'resize'},

    {'name': 'kernel_size', 'fixed': True, 'value': 3},
    {'name': 'stride_conv', 'fixed': True, 'value': 1},
    {'name': 'padding', 'fixed': True, 'value': 'same'},
    {'name': 'activation', 'fixed': True, 'value': 'swish'},
    {'name': 'pool_size', 'fixed': True, 'value': 2},
    {'name': 'stride_pool', 'fixed': True, 'value': 2},
    ...
    {'name': 'patience', 'fixed': True, 'value': 5},
